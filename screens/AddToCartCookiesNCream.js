...
const AddToCartCookiesNCream = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2022/12/COOKIESPARFAITSANDSHAKESWEBSITE-01.png'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Cookies & Cream Parfait</Text>
      </View>
...
export default AddToCartCookiesNCream;
