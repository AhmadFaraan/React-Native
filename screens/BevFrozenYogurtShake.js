...
const data = [
  { id: '1', name: 'Caramel Shake',  image: require('../assets/CaramelShake.jpg') },
  { id: '2', name: 'Chocolate Shake',  image: require('../assets/ChocolateShake.jpg') },
  { id: '3', name: 'Strawberry Shake',  image: require('../assets/StrawberryShake.jpg') },
  { id: '4', name: 'Mixed Berry Fusion Parfait',  image: require('../assets/FrozenYog.webp') },
  { id: '5', name: 'Cookies & Cream Parfait',  image: require('../assets/CookiesandCream.jpg') },
...
const BevFrozenYogurtShake = () => {
  ...
  const handleItemClick = (item) => {
    if (item.id === '1') {
      navigation.navigate('AddToCartCaramel');
    } else if (item.id === '2') {
      navigation.navigate('AddToCartChocolateShake');
    } else if (item.id === '3') {
      navigation.navigate('AddToCartStrawberryShake');
    } else if (item.id === '4') {
      navigation.navigate('AddToCartFrozenYog');
    } else if (item.id === '5') {
      navigation.navigate('AddToCartCookiesNCream');
    }
  };
      ...
      <FlatList
        ...
        ListHeaderComponent={() => (
          <View style={styles.listContainer}>
            <Text style={styles.Heading}>FROZEN YOGURT PARFAITS AND SHAKES</Text>
          </View>
        )}
        // Add footer content 
        ListFooterComponent={() => (
...
export default BevFrozenYogurtShake;