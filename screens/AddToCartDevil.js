...
const AddToCartDevil = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2023/05/Devil-Fudge-cake.png'; // Set your product image URL

  // Function to add item to cart
  const addToCart = () => {
    const item = {
      name: 'Devil Fudge Cake',
      image: imageUrl,
      size: size,
      quantity: quantity,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Devil Fudge Cake</Text>
      </View>
