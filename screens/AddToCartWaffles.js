...
const AddToCartWaffles = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2023/05/1.jpeg'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Waffles</Text>
      </View>
...
export default AddToCartWaffles;
