...
const AddToCartFrochers = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2023/05/ferrero-rocher.png'; // Set your product image URL

  // Function to add item to cart
  const addToCart = () => {
    const item = {
      name: 'Ferrero Rochers Cake',
      image: imageUrl,
      size: size,
      quantity: quantity,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Ferrero Rochers Cake</Text>
      </View>
...
export default AddToCartFrochers;
