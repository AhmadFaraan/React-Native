...
const data = [
    { id: '1', name: 'Lotus Cake',  image: require('../assets/Cakes.jpg') },
    { id: '2', name: 'Three Milk Cake',  image: require('../assets/ThreeMilkCake.webp') },
    { id: '3', name: 'Devil Fudge Cake',  image: require('../assets/DevilFudgeCake.webp') },
    { id: '4', name: 'Ferrero Rocher',  image: require('../assets/FerreroRocher.webp') },
];
...
const Food_Cakes = () => {
  ...
  const handleItemClick = (item) => {
    if (item.id === '1') {
      navigation.navigate('AddToCartLotusCake');
    } else if (item.id === '2') {
      navigation.navigate('AddToCartThree');
    } else if (item.id === '3') {
      navigation.navigate('AddToCartDevil');
    } else if (item.id === '4') {
      navigation.navigate('AddToCartFrochers');
    } 
  };
      ...
      <FlatList
        ...
        ListHeaderComponent={() => (
          <View style={styles.listContainer}>
            <Text style={styles.Heading}>CAKES</Text>
          </View>
        )}
        // Add footer content 
        ListFooterComponent={() => (
