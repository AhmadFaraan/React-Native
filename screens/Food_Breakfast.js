...
const data = [
  { id: '1', name: 'Waffles',  image: require('../assets/Waffles.jpg') },
  { id: '2', name: 'Nuttela French Toast',  image: require('../assets/NuttelaFrenchToast.jpg') },
  { id: '3', name: 'Spanish Omelet',  image: require('../assets/SpanishOmelet.webp') },
  { id: '4', name: 'Pancakes',  image: require('../assets/Pancakes.webp') },
  { id: '5', name: 'Crum Brunch Omelete',  image: require('../assets/CrumBrunchOmellete.webp') },
  { id: '6', name: 'Classis Egg & Melted Cheese Sandwich',  image: require('../assets/EggandCheese.webp') },
];
...
const Food_Breakfast = () => {
  ...
  const handleItemClick = (item) => {
    if (item.id === '1') {
      navigation.navigate('AddToCartWaffles');
    } else if (item.id === '2') {
      navigation.navigate('AddToCartNutella');
    } else if (item.id === '3') {
      navigation.navigate('AddToCartOmlet');
    } else if (item.id === '4') {
      navigation.navigate('AddToCartPancake');
    } else if (item.id === '5') {
      navigation.navigate('AddToCartCrum');
    } else if (item.id === '6') {
      navigation.navigate('AddToCartEggN');
    }
  };
