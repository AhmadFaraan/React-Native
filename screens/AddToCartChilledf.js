...
const AddToCartChilledf = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2022/12/HOTDRINKSWEBSITE-01.png'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Frozen Chocolate</Text>
      </View>
...
export default AddToCartChilledf;
