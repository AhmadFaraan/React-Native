...
const AddToCartTart = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2023/05/Chocolate-Tart.png'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Chocolate Tart</Text>
      </View>
