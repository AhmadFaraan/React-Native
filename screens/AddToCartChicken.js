...
const AddToCartChicken = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2023/05/sv-sfv53.jpeg'; // Set your product image URL

  // Function to add item to cart
  const addToCart = () => {
    const item = {
      name: 'Pesto Grilled Chicken Sandwich',
      image: imageUrl,
      size: size,
      quantity: quantity,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Pestro Grilled Chicken Sandwich</Text>
      </View>
...
export default AddToCartChicken;
