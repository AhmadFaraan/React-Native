...
const AddToCartNutella = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2023/05/4.jpeg'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Nutella French Toast</Text>
      </View>
...
export default AddToCartNutella;
