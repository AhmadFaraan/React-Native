...
const AddToCartItalianSoda = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2022/12/blueberry-italian-soda.png'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Italian Soda</Text>
      </View>
...
export default AddToCartItalianSoda;
