...
const AddToCartSusCoffee = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2022/12/americanonoreflection.png'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Sustainable Coffee</Text>
      </View>
...
export default AddToCartSusCoffee;
