...
const AddToCartSandwich = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2023/05/adcd5.jpeg'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Club Sandwich</Text>
      </View>
...
export default AddToCartSandwich;
