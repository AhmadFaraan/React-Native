...
const AddToCartHotChocolate = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2022/12/Cookies-and-cream-hot-chocolate.png'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Hot Chocolate</Text>
      </View>
...
export default AddToCartHotChocolate;
