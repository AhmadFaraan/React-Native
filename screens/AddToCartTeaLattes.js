...
const AddToCartTeaLattes = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2022/12/green-tea-latte.png'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Tea Latte</Text>
      </View>
...
export default AddToCartTeaLattes;
