...
const AddToCartFrozenYog = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2022/12/WILDBERRYPARFAITWEBSITE-01.png'; // Set your product image URL

  // Function to add item to cart
  const addToCart = () => {
    const item = {
      name: 'Mixed Berry Fusion Parfait',
      image: imageUrl,
      size: size,
      quantity: quantity,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Mixed Berry Fusion Parfait</Text>
      </View>
...
export default AddToCartFrozenYog;
