...
const AddToCartEggN= () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2023/05/6.jpeg'; // Set your product image URL

  // Function to add item to cart
  const addToCart = () => {
    const item = {
      name: 'Classic Egg & Melted Cheese Sandwich',
      image: imageUrl,
      size: size,
      quantity: quantity,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Classic Egg & Melted Cheese Sandwich</Text>
      </View>
