...
const data = [
  { id: '1', name: 'Butterscotch Muffin',  image: require('../assets/ButterscotchMuffin.jpg') },
...
const Food_FreshlyBaked = () => {
  ...
  const handleItemClick = (item) => {
    if (item.id === '1') {
      navigation.navigate('AddToCartMuffin');
    }
  };
      ...
      <FlatList
        ...
        ListHeaderComponent={() => (
          <View style={styles.listContainer}>
            <Text style={styles.Heading}>FRESHLY BAKED</Text>
          </View>
        )}
        // Add footer content 
        ListFooterComponent={() => (
...
export default Food_FreshlyBaked;