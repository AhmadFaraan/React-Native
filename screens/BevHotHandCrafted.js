...
const data = [
  { id: '1', name: 'Caramel Corretto', image: require('../assets/HotHandcrafted.jpg') },
  { id: '2', name: 'Espresso', image: require('../assets/Espressos.webp') },
  { id: '3', name: 'Tea Latte', image: require('../assets/TeaLattes.jpg') },
  { id: '4', name: 'Hot Chocolate', image: require('../assets/HotChocolates.jpg') },
];
...
const BevHotHandCrafted = () => {
  ...
  const handleItemClick = (item) => {
    if (item.id === '1') {
      ...
      navigation.navigate('AddToCartEspresso');
    } else if (item.id === '3') {
      navigation.navigate('AddToCartTeaLattes');
    } else if (item.id === '4') {
      navigation.navigate('AddToCartHotChocolate');
    } 
  };
      ...
      <FlatList
        ...
        ListHeaderComponent={() => (
          <View style={styles.listContainer}>
            <Text style={styles.Heading}>HOT HANDCRAFTED</Text>
          </View>
        )}
                                         // Add footer content 
        ListFooterComponent={() => (
...
export default BevHotHandCrafted;
