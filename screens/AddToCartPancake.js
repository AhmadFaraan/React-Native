...
const AddToCartPancake = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2023/05/3.jpeg'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Pancakes</Text>
      </View>
...
export default AddToCartPancake;
