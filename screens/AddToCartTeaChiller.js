...
const AddToCartTeaChiller = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2022/12/green-tea-chiller.png'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Tea Chiller</Text>
      </View>
...
export default AddToCartTeaChiller;
