...
const data = [
  { id: '1', name: 'Sustainable Coffee',  image: require('../assets/SustainableCoffee.jpg') },
  { id: '2', name: 'Organic Tea', image: require('../assets/OrganicTea.jpg') },
];
...
const BevSignatures = () => {
  ...
  const handleItemClick = (item) => {
    if (item.id === '1') {
      navigation.navigate('AddToCartSusCoffee');
    } else if (item.id === '2') {
      navigation.navigate('AddToCartOrganicTea');
    }
  };
