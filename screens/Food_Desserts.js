...
const data = [
  { id: '1', name: 'Special Brownie',  image: require('../assets/SpecialBrownie.webp') },
  { id: '2', name: 'Lotus Sundae',  image: require('../assets/LotusSundae.webp') },
  { id: '3', name: 'Chocolate Tart',  image: require('../assets/ChocolateTarrt.webp') },
  { id: '4', name: 'Lemon Tart',  image: require('../assets/LemonTart.webp') },
];
...
const Food_Desserts = () => {
  ...
  const handleItemClick = (item) => {
    if (item.id === '1') {
      navigation.navigate('AddToCartBrownie');
    } else if (item.id === '2') {
      navigation.navigate('AddToCartLotus');
    } else if (item.id === '3') {
      navigation.navigate('AddToCartTart');
    } else if (item.id === '4') {
      navigation.navigate('AddToCartLemon');
    } 
  };
