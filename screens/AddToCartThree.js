...
const AddToCartThree = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2023/05/three-Milk-Cake.png'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Three Milk Cake</Text>
      </View>
