...
const AddToCartEspresso = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2022/12/espresso.png'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Espresso</Text>
      </View>
...
export default AddToCartEspresso;
