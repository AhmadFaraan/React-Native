...
const data = [
  { id: '1', name: 'Sandwiches and Wraps',  image: require('../assets/SandwitchedandWrap.jpg') },
  { id: '2', name: 'Desserts', image: require('../assets/Dessert.webp') },
  { id: '3', name: 'Breakfast',  image: require('../assets/Waffles.jpg') },
  { id: '4', name: 'Cakes', image: require('../assets/Cakes.jpg') },
  { id: '5', name: 'Freshly Baked', image: require('../assets/croissant.webp') },
];
...
const Food = () => {
  ...
  const handleItemClick = (item) => {
    if (item.id === '1') {
      ...
      navigation.navigate('Food_Cakes');
    } else if (item.id === '5') {
      navigation.navigate('Food_FreshlyBaked');
    } 
  };
