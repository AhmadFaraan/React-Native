    ...
    <View style={styles.container}>
      ...
      <View style={styles.textContainer}>
        ...
        <Text style={styles.paragraph}>
          Welcome to our app! We are dedicated to providing an exceptional experience for our users. Our mission is to briefly describe the purpose of your app and what sets it apart. Thank you for choosing our app. Your support means the world to us.
        </Text>
      </View>
      ...
      <View style={styles.supportCenterContainer}>
        ...
        <TouchableOpacity onPress={handlePrivacyPolicyPress}>
          <Text style={styles.link}>Queries | Contact Us</Text>
        </TouchableOpacity>
      </View>
