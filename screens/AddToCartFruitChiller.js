...
const AddToCartFruitChiller = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2022/12/banana-fruit-chiller.png'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Fruit Chiller</Text>
      </View>
...
export default AddToCartFruitChiller;
