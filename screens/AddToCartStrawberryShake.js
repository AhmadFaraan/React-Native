...
const AddToCartStrawberryShake = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2022/12/STRAWBSHAKEWEBSITE-01.png'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Strawberry Shake</Text>
      </View>
...
export default AddToCartStrawberryShake;
