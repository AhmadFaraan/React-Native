...
const AddToCartMuffin = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2023/05/234cx.jpeg'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Butterscotch Muffin</Text>
      </View>
...
export default AddToCartMuffin;
