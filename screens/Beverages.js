...
const data = [
  { id: '1', name: 'Hot HandCrafted', image: require('../assets/HotHandcrafted.jpg') },
  { id: '2', name: 'Chilled Favourites', image: require('../assets/ChilledFavourites.jpg') },
  { id: '3', name: 'Frozen Yogurt Parfaits and Shakes', image: require('../assets/ColdPressedJuice.jpg') },
  { id: '4', name: 'Cold Pressed Juice', image: require('../assets/FrozanYogurtShake.jpg') },
  { id: '5', name: 'Signatures', image: require('../assets/Signature.jpg') },
...
const Beverages = () => {
  ...
  const handleItemClick = (item) => {
    if (item.id === '1') {
      navigation.navigate('BevHotHandCrafted');
    } else if (item.id === '2') {
      navigation.navigate('BevChilledFavourites');
    } else if (item.id === '3') {
      navigation.navigate('BevFrozenYogurtShake');
    } else if (item.id === '4') {
      navigation.navigate('BevColdPressedJuice');
    } else if (item.id === '5') {
      navigation.navigate('BevSignatures');
    }
  };
