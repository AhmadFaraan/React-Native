...
const AddToCartBurger = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2023/05/fvr45.jpeg'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Signature Burger</Text>
      </View>
...
export default AddToCartBurger;
