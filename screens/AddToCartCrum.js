...
const AddToCartCrum = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2023/05/5.jpeg'; // Set your product image URL

  // Function to add item to cart
  const addToCart = () => {
    const item = {
      name: 'Crum Brunch Omelete',
      image: imageUrl,
      size: size,
      quantity: quantity,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Crum Brunch Omelet</Text>
      </View>
