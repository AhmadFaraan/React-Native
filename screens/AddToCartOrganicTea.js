...
const AddToCartOrganicTea = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2022/12/NORMALTEA.png'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Organic Tea</Text>
      </View>
...
export default AddToCartOrganicTea;
