...
const data = [
  { id: '1', name: 'Frozen Chocolate',  image: require('../assets/ChilledFavourites.jpg') },
  { id: '2', name: 'Coffee Chiller', image: require('../assets/CoffeeChillers.jpg') },
  { id: '3', name: 'Tea Chiller', image: require('../assets/TeaChillers.jpg') },
  { id: '4', name: 'Fruit Chiller',  image: require('../assets/FruitChillers.jpg') },
  { id: '5', name: 'Italian Soda',  image: require('../assets/ItalianSodas.jpg') },
];
...
const BevChilledFavourites = () => {
  ...
  const handleItemClick = (item) => {
    if (item.id === '1') {
      navigation.navigate('AddToCartChilledf');
    } else if (item.id === '2') {
      navigation.navigate('AddToCartCoffeeChiller');
    } else if (item.id === '3') {
      navigation.navigate('AddToCartTeaChiller');
    } else if (item.id === '4') {
      navigation.navigate('AddToCartFruitChiller');
    } else if (item.id === '5') {
      navigation.navigate('AddToCartItalianSoda');
    }
  };
      ...
      <FlatList
        ...
        ListHeaderComponent={() => (
          <View style={styles.listContainer}>
            <Text style={styles.Heading}>CHILLERS</Text>
          </View>
        )}
        // Add footer content 
        ListFooterComponent={() => (
...
export default BevChilledFavourites;