...
const data = [
  { id: '1', name: 'Signature Burger',  image: require('../assets/SignatureBurger.jpg') },
  { id: '2', name: 'Club Sandwich',  image: require('../assets/SandwitchedandWrap.jpg') },
  { id: '3', name: 'Caesar Wrap',  image: require('../assets/CaesarWrap.jpg') },
  { id: '4', name: 'Pesto Grilled Chicken Sandwich',  image: require('../assets/PestroGrilled.jpg') },
];
...
const Food_SandwichesAndWraps = () => {
  ...
  const handleItemClick = (item) => {
    if (item.id === '1') {
      navigation.navigate('AddToCartBurger');
    } else if (item.id === '2') {
      navigation.navigate('AddToCartSandwich');
    } else if (item.id === '3') {
      navigation.navigate('AddToCartWrap');
    } else if (item.id === '4') {
      navigation.navigate('AddToCartChicken');
    }
  };
      ...
      <FlatList
        ...
        ListHeaderComponent={() => (
          <View style={styles.listContainer}>
            <Text style={styles.Heading}>SANDWICH WRAPS & BURGERS</Text>
          </View>
        )}
        // Add footer content 
        ListFooterComponent={() => (
...
export default Food_SandwichesAndWraps;