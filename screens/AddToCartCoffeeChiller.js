...
const AddToCartCoffeeChiller = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2022/12/mocha.png'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Coffee Chiller</Text>
      </View>
...
export default AddToCartCoffeeChiller;
