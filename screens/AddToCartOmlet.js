...
const AddToCartOmlet = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2023/05/2.jpeg'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Spanish Omelet</Text>
      </View>
