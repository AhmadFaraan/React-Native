...
const AddToCart = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2022/12/caramel-corretto.png'; // Set your product image URL

  // Function to add item to cart
  const addToCart = () => {
    const item = {
      name: 'Caramel Corretto',
      image: imageUrl,
      size: size,
      quantity: quantity,
    ...
    >
      <ScrollView contentContainerStyle={styles.scrollViewContainer}>
        ...
        <View style={styles.imageContainer}>
          ...
          <Text style={styles.imageText}>Caramel Corretto</Text>
        </View>
