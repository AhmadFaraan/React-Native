...
const AddToCartLemon = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2023/05/Lemon-Tart.png'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Lemon Tart</Text>
      </View>
