...
const AddToCartCaramel = () => {
  ...
  const imageUrl = 'https://secondcup.pk/wp-content/uploads/2022/12/CARAMELSHAKEWEBSITE-01.png'; // Set your product image URL
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.imageText}>Caramel Shake</Text>
      </View>
...
export default AddToCartCaramel;
